---
title: "An introduction to the TENxMultiomeTools package"
...
This pipeline is designed for differential analysis of multiple samples in 
...
```{r}
tsne <- plotTSNE(sce,colour_by="SingleR")
```
