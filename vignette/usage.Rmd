...
solution to this problem by adapting the `finalRegions` function present in the DEScan2 package.
...
Both previous operations can be made with our wrapper `computePseudoBulk` in a 
unique instruction
...
In order to visualize tracks for the 
